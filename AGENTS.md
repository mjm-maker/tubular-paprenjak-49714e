...
- Subtitle timings come from the model, not from forced alignment, so they can be a little loose on fast or overlapping speech. The cue text is editable before rendering; the timings are not.
